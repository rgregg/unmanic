  ...
  <div class="column fit drawer-background">
    ...
    <q-scroll-area class="col">
      <q-list padding>
        ...
        <!-- Local fork: Unmanic Central link removed.
             central.unmanic.app aggregates linked installations,
             supporter status, etc. via api.unmanic.app — all of which
             this fork stubs to no-ops. The page would be blank/dead. -->

        <!-- Local fork: account login / logout items removed.
             Session level is pinned to LOCAL_SESSION_LEVEL=7 by
             register_unmanic; the device-flow OAuth and remote logout
             endpoints are stubbed to no-ops. There is no account to log
             into. -->
